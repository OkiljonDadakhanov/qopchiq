...
export const createProduct = async (req, res, next) => {
        try {
                ...
                const dietaryPreferences = parseArrayField(body.dietaryPreferences ?? body.diet ?? body.dietary);
                if (dietaryPreferences !== undefined) body.dietaryPreferences = dietaryPreferences;

                if (body.foodType === "" || body.foodType === null || body.foodType === "null") {
                        body.foodType = null;
                }
